      ...
      <main id="main">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <div class="grid sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-14">
            ...
            <a href="#" class="bg-sand-100/60 hover:bg-sand-100 rounded-2xl p-5 text-center transition-colors focus-ring">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1B3E32" stroke-width="1.6" class="mx-auto mb-3"><path d="m22 2-11 20-2.5-8L2 11.5Z" /></svg>
              <p class="text-xs font-medium">تلگرام</p>
              <p class="text-[11px] text-ink-faint mt-1">talargah_support@</p>
            </a>
            <a href="#" class="bg-sand-100/60 hover:bg-sand-100 rounded-2xl p-5 text-center transition-colors focus-ring">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1B3E32" stroke-width="1.6" class="mx-auto mb-3"><rect x="3" y="3" width="18" height="18" rx="5" /><circle cx="12" cy="12" r="3.5" /><circle cx="17.5" cy="6.5" r="1" /></svg>
            ...
            <div class="bg-sand-100/60 rounded-2xl p-5 text-center">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1B3E32" stroke-width="1.6" class="mx-auto mb-3"><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 3" /></svg>
          ...
          <div class="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 lg:gap-14">
            ...
            <section>
              ...
              <form id="contact-form" class="space-y-5" novalidate>
                ...
                <button id="submit-btn" type="submit" class="w-full sm:w-auto flex items-center justify-center gap-2 bg-emerald-800 hover:bg-emerald-700 text-sand-50 text-sm font-medium px-8 py-3.5 rounded-xl transition-colors focus-ring">
                  <svg id="submit-spinner" class="spinner hidden" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9" stroke-opacity=".25" /><path d="M21 12a9 9 0 0 0-9-9" /></svg>
                ...
                <div id="success-msg" class="hidden items-start gap-3 bg-emerald-800/10 text-emerald-800 rounded-xl px-4 py-4 mt-2">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="shrink-0 mt-0.5"><circle cx="12" cy="12" r="9" /><path d="m8.5 12.5 2.5 2.5 5-5" /></svg>
                  <div>
            ...
            <section>
              ...
              <div class="flex items-start gap-2.5 text-xs text-ink-faint bg-gold-300/25 rounded-xl px-4 py-3">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#9A6E30" stroke-width="1.8" class="shrink-0 mt-0.5"><path d="M19 17h2l-1.5-6H4.5L3 17h2M5 17v3M19 17v3M6 11l1.5-4h9L18 11" /></svg>
              ...
              <div class="grid grid-cols-3 gap-3 mt-8">
                <div class="text-center">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1B3E32" stroke-width="1.6" class="mx-auto mb-2"><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 3" /></svg>
                  <p class="text-[11px] text-ink-soft leading-relaxed">پاسخ سریع</p>
                </div>
                <div class="text-center">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1B3E32" stroke-width="1.6" class="mx-auto mb-2"><path d="M20.4 4.6a5 5 0 0 0-7.1 0L12 5.9l-1.3-1.3a5 5 0 0 0-7.1 7.1L12 20.4l8.4-8.7a5 5 0 0 0 0-7.1Z" /></svg>
                  <p class="text-[11px] text-ink-soft leading-relaxed">پشتیبانی حرفه‌ای</p>
                </div>
                <div class="text-center">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1B3E32" stroke-width="1.6" class="mx-auto mb-2"><path d="M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></svg>
            ...
            <div class="grid sm:grid-cols-2 gap-3">
              <details class="group bg-sand-100/60 rounded-xl p-4 [&_summary::-webkit-details-marker]:hidden">
                <summary class="flex items-center justify-between cursor-pointer text-sm font-medium focus-ring">
                  ...
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#54493D" stroke-width="2" class="shrink-0 transition-transform group-open:rotate-45"><path d="M12 5v14M5 12h14" /></svg>
                </summary>
