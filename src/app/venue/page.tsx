          ...
          <div>
            ...
            <div class="flex items-start justify-between gap-4 pb-6 border-b border-sand-200">
              <div>
                ...
                <div class="flex items-center gap-3 text-sm text-ink-soft flex-wrap">
                  ...
                  <span class="flex items-center gap-1">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M12 22s7-5.2 7-11a7 7 0 1 0-14 0c0 5.8 7 11 7 11Z"/><circle cx="12" cy="11" r="2.4"/></svg>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 py-6">
              <div class="bg-sand-100/60 rounded-2xl p-4">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1B3E32" strokeWidth="1.6" class="mb-2.5"><path d="M17 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2"/><circle cx="10" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                <p class="text-xs text-ink-faint">ظرفیت</p>
                <p class="text-sm font-semibold mt-0.5 num">۶۰۰ نفر</p>
              </div>
              <div class="bg-sand-100/60 rounded-2xl p-4">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1B3E32" strokeWidth="1.6" class="mb-2.5"><path d="M12 22s7-5.2 7-11a7 7 0 1 0-14 0c0 5.8 7 11 7 11Z"/><circle cx="12" cy="11" r="2.4"/></svg>
                <p class="text-xs text-ink-faint">نوع تالار</p>
                <p class="text-sm font-semibold mt-0.5">فضای بسته و باز</p>
              </div>
              <div class="bg-sand-100/60 rounded-2xl p-4">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1B3E32" strokeWidth="1.6" class="mb-2.5"><path d="M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                <p class="text-xs text-ink-faint">محدوده قیمت</p>
                <p class="text-sm font-semibold mt-0.5 num">از ۸۵۰ میلیون</p>
              </div>
              <div class="bg-sand-100/60 rounded-2xl p-4">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1B3E32" strokeWidth="1.6" class="mb-2.5"><path d="M19 17h2l-1.5-6H4.5L3 17h2M5 17v3M19 17v3M6 11l1.5-4h9L18 11"/></svg>
            ...
            <section class="py-8 border-t border-sand-200">
              ...
              <div class="grid grid-cols-2 sm:grid-cols-3 gap-x-6 gap-y-5">
                <div class="flex items-center gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#54493D" strokeWidth="1.6" class="shrink-0"><path d="M19 17h2l-1.5-6H4.5L3 17h2M5 17v3M19 17v3M6 11l1.5-4h9L18 11"/></svg>
                  <span class="text-sm text-ink-soft">پارکینگ اختصاصی</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#54493D" strokeWidth="1.6" class="shrink-0"><path d="M20.4 4.6a5 5 0 0 0-7.1 0L12 5.9l-1.3-1.3a5 5 0 0 0-7.1 7.1L12 20.4l8.4-8.7a5 5 0 0 0 0-7.1Z"/></svg>
                  <span class="text-sm text-ink-soft">اتاق عروس</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#54493D" strokeWidth="1.6" class="shrink-0"><rect x="4" y="4" width="16" height="16" rx="2"/><path d="M4 10h16"/></svg>
                  <span class="text-sm text-ink-soft">اتاق داماد</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#54493D" strokeWidth="1.6" class="shrink-0"><rect x="3" y="12" width="18" height="8" rx="1"/><path d="M7 12V8a5 5 0 0 1 10 0v4"/></svg>
                  <span class="text-sm text-ink-soft">سن اجرا و DJ</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#54493D" strokeWidth="1.6" class="shrink-0"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M22 10 12 4 2 10"/></svg>
                  <span class="text-sm text-ink-soft">صفحه‌نمایش LED</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#54493D" strokeWidth="1.6" class="shrink-0"><path d="M12 3v3m0 12v3m9-9h-3M6 12H3m14.5-6.5-2 2m-9 9-2 2m0-13 2 2m9 9 2 2"/><circle cx="12" cy="12" r="4"/></svg>
                  <span class="text-sm text-ink-soft">سرمایش و گرمایش</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#54493D" strokeWidth="1.6" class="shrink-0"><rect x="3" y="8" width="14" height="10" rx="1"/><path d="M17 11.5 21 9v6l-4-2.5"/></svg>
                  <span class="text-sm text-ink-soft">دوربین ثبت مراسم</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#54493D" strokeWidth="1.6" class="shrink-0"><circle cx="12" cy="5" r="2"/><path d="M12 7v5M8 22l4-10 4 10M6 13h12"/></svg>
                  <span class="text-sm text-ink-soft">دسترسی ویلچر</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#54493D" strokeWidth="1.6" class="shrink-0"><path d="M12 2 3 6v6c0 5 4 9 9 10 5-1 9-5 9-10V6Z"/></svg>
                  <span class="text-sm text-ink-soft">نمازخانه</span>
                </div>
                <div class="flex items-center gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#54493D" strokeWidth="1.6" class="shrink-0"><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/><path d="M9 17h6M5 17l1-9h12l1 9M6 8l2-4h8l2 4"/></svg>
            ...
            <section class="py-8 border-t border-sand-200">
              ...
              <div class="flex items-start gap-2.5 mt-4 text-xs text-ink-faint bg-gold-300/25 rounded-xl px-4 py-3">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#9A6E30" strokeWidth="1.8" class="shrink-0 mt-0.5"><circle cx="12" cy="12" r="9"/><path d="M12 8v5M12 16h.01"/></svg>
              ...
              <div>
                <details class="group border-t border-sand-200 py-4 [&_summary::-webkit-details-marker]:hidden">
                  <summary class="flex items-center justify-between cursor-pointer text-sm font-medium focus-ring">
                    ...
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#54493D" strokeWidth="1.8" class="shrink-0 transition-transform group-open:rotate-45"><path d="M12 5v14M5 12h14"/></svg>
                  </summary>
            ...
            <div class="sticky top-28 rounded-3xl border border-sand-200 p-6 shadow-soft">
              ...
              <div class="flex flex-col gap-3 mt-6">
                ...
                <button class="flex items-center justify-center gap-2 border border-sand-300 hover:border-ink text-ink text-sm font-medium py-3.5 rounded-xl transition-colors focus-ring">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M21 11.5a8.5 8.5 0 0 1-12.3 7.6L3 20l1-5.6A8.5 8.5 0 1 1 21 11.5Z"/></svg>
                ...
                <a href="#map" class="flex items-center justify-center gap-2 text-emerald-700 hover:text-emerald-800 text-sm font-medium py-2 transition-colors focus-ring">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M12 22s7-5.2 7-11a7 7 0 1 0-14 0c0 5.8 7 11 7 11Z"/><circle cx="12" cy="11" r="2.4"/></svg>
                  مسیریابی تا تالار
                </a>
              </div>
    ...
    <div class="lg:hidden fixed bottom-0 inset-x-0 z-40 bg-sand-50/95 backdrop-blur-md border-t border-sand-200 px-4 py-3">
      <div class="flex items-center gap-2">
        ...
        <button class="flex items-center gap-1.5 border border-sand-300 text-ink text-sm font-medium px-4 h-12 rounded-xl focus-ring shrink-0">
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M21 11.5a8.5 8.5 0 0 1-12.3 7.6L3 20l1-5.6A8.5 8.5 0 1 1 21 11.5Z"/></svg>
          مشاوره
        </button>
          ...
          <div class="col-span-2 lg:col-span-1">
            ...
            <div class="flex gap-3">
              ...
              <a href="#" aria-label="تلگرام" class="w-9 h-9 rounded-full bg-sand-50/10 flex items-center justify-center hover:bg-sand-50/20 transition-colors focus-ring">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="m22 2-11 20-2.5-8L2 11.5Z" /></svg>
              </a>
            </div>
          </div>
        </div>
